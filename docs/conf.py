...
project = 'dj-easy-pdf'
copyright = jinja2.filters.do_mark_safe('%s, <a href="https://williamotieno.tech">William Otieno</a>' % datetime.date.today().year)
...
htmlhelp_basename = 'dj-easy-pdfdoc'
...
latex_documents = [
  ('index', 'dj-easy-pdf.tex', u'dj-easy-pdf Documentation',
   u'William Otieno', 'manual'),
]
...
man_pages = [
    ('index', 'dj-easy-pdf', u'dj-easy-pdf Documentation',
     ['William Otieno'], 1)
]
...
texinfo_documents = [
  ('index', 'dj-easy-pdf', u'dj-easy-pdf Documentation',
   'William Otieno', 'dj-easy-pdf', 'One line description of project.',
   'Miscellaneous'),
]
